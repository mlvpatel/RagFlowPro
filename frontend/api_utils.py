...
def stream_chat(question: str, session_id, model: str):
    """Yield {'token': ...} events, then a final {'done': True, 'session_id': ...}."""
    ...
    for line in response.iter_lines(decode_unicode=True):
        ...
        if "token" in payload:
            ...
            yield {"done": True, "session_id": payload.get("session_id")}
